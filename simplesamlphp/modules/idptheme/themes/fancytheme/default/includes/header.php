...
echo '<center>';
echo '<div class="html-rainbow-text" style="text-align: center;">
	<span style="color:#ff823d">I</span><span style="color:#ffc63d">d</span><span style="color:#f4ff3d">e</span><span style="color:#afff3d">n</span><span style="color:#6bff3d">t</span><span style="color:#3dff54">i</span><span style="color:#3dff98">t</span><span style="color:#3dffdd">y</span><span style="color: transparent;text-shadow: none;">&nbsp;</span><span style="color:#3d98ff">P</span><span style="color:#3d54ff">r</span><span style="color:#6b3dff">o</span><span style="color:#af3dff">v</span><span style="color:#f43dff">i</span><span style="color:#ff3dc6">d</span><span style="color:#ff3d82">e</span><span style="color:#ff3d3d">r</span>
</div>';
echo '</center>';
        ?></a></h1>
    </div>
